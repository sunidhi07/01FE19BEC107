...
# Generated on: Fri Dec 03 17:07:28 IST 2021 (Fri Dec 03 11:37:28 GMT 2021)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/upcounter/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/upcounter -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k upcounter.v
elaborate_design -golden -root {upcounter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/upcounter/fv_map.v.gz
elaborate_design -revised -root {upcounter}
...
#add_name_alias fv/upcounter/fv_map.singlebit.original_name.alias.json.gz -revised
